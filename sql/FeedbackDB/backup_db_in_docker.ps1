...
# PowerShell Core script for backing up FeedbackDB
Write-Host "Starting the script to backup FeedbackDB..."
...
# Check if FeedbackDB exists
Write-Host "Verifying FeedbackDB exists..."
$query = @"
SELECT name 
