...
# PowerShell Core script for backing up CommunityService
Write-Host "Starting the script to backup CommunityService..."
...
# Check if CommunityService exists
Write-Host "Verifying CommunityService exists..."
$query = @"
SELECT name 
