...
# PowerShell Core script for backing up RightsDB
Write-Host "Starting the script to backup RightsDB..."
...
# Check if RightsDB exists
Write-Host "Verifying RightsDB exists..."
$query = @"
SELECT name 
